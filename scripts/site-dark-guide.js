...
const darkGuideData={
  ...
  S90:{
    title:'S90',trim:'B5 ULTRA DARK',price:'7,130만 원',
    image:'https://www.volvocars.com/images/cs/v3/assets/blt0feaa88e629251fc/blt167372f32031a6f1/687a13e4715092336a758f44/Exterior-bento-front-4x5-S90-PHEV.jpg?branch=prod_alias&format=auto&iar=0&quality=85&w=1920',
    parts:['전면 그릴 및 크롬 계열 외장 디테일의 블랙 테마','블랙 사이드미러 커버','사이드 윈도우 주변 블랙 데코'],
    note:'S90 Dark는 Ultra의 주요 편의·시트·오디오 사양은 그대로 유지하면서 그릴, 사이드미러, 윈도우 데코 등 외장 포인트를 블랙 계열로 바꾸는 테마입니다. 휠은 Dark 전용 차이로 안내하지 않습니다.',
    markers:[['1',27,44,34,13],['2',69,40,12,12],['3',49,28,31,11]]
  }
};
